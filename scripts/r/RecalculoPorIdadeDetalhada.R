################################################################################
# RECÁLCULO DA IDADE DETALHADA — V14.1
#
...
script <- file.path(project_root, "scripts", "python", "RecalculoDosIndicadores.py")
...
message("Recálculo completo e idade detalhada concluídos pela versão unificada 14.1.")
