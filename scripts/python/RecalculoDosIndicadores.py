...
DATA_FILE = ROOT / "assets" / "js" / "dados" / "BaseAnaliticaDoVigitel.js"
METHOD_FILE = ROOT / "assets" / "js" / "dados" / "MetodologiaDosIndicadores.js"
AGE_DIR = ROOT / "assets" / "js" / "dados" / "idade-detalhada"
REPORT_FILE = ROOT / "relatorios" / "RelatorioDeValidacaoDosIndicadores.txt"
...
def main() -> None:
    ...
    indicator_files = {item["id"]: "assets/js/dados/idade-detalhada/" + bundle_filename(item["id"]) for item in indicators}
    ...
    for prefix, bundle_name in BUNDLE_BY_PREFIX.items():
        ...
        sections = [
            ...
            " * O agrupamento mantém os dados temáticos compactos e carregáveis sob demanda pelo navegador.",
            " */",
            "",
        ]
    ...
    age_index = {
        "meta": {
            ...
            "version": "edicaoAcademicaConsolidadaOrganizada",
            "distribution": "Arquivos organizados por responsabilidade; dados detalhados agrupados por tema.",
            "ageVariable": "q6",
    ...
    (ROOT / "assets" / "js" / "dados" / "CatalogoDeIdadeDetalhada.js").write_text(
        "/**\n"
    ...
    METHOD_FILE.write_text(
        "/**\n"
        " * Reúne a definição metodológica usada na apresentação e na conferência dos indicadores.\n"
        " * O conteúdo é gerado a partir das regras validadas; alterações manuais devem ser reproduzidas\n"
        " * também nos scripts de recálculo para não se perderem na atualização seguinte.\n"
        " */\n\n"
    ...
    DATA_FILE.write_text(
        "/**\n"
        " * Base agregada consumida pelo painel público.\n"
        " * O arquivo é produzido pelo recálculo validado e não deve receber valores manuais.\n"
        " */\n\n"
...
def validate(data: dict, indicators: List[dict]) -> None:
    """Confere a estrutura e a coerência dos resultados processados antes da gravação.
    """
    lines = [
        "RELATÓRIO DE VALIDAÇÃO DOS INDICADORES — V14.1",
        "=" * 62,
